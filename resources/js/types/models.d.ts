...
declare global {
  export namespace model {
    ...
    export interface AnggotaKelas {
      ...
      updated_at: string | null
      // relations
      hasil_penilaians: HasilPenilaian[]
      anggota_ekskuls: AnggotaEkskul[]
      anggota_proyeks: AnggotaProyek[]
      catatan_wali_kelas: CatatanWaliKela[]
      siswa: Siswa
      kelas: Kela
      // counts
      hasil_penilaians_count: number
      anggota_ekskuls_count: number
      anggota_proyeks_count: number
      catatan_wali_kelas_count: number
      // exists
      hasil_penilaians_exists: boolean
      anggota_ekskuls_exists: boolean
    ...
    export interface Dimensi {
      ...
      elemens: Eleman[]
      // counts
      elemens_count: number
      // exists
      elemens_exists: boolean
    }
    ...
    export interface Elemen {
      ...
      deskripsi: string
      // relations
      subelemens: Subeleman[]
      dimensi: Dimensi
      // counts
      subelemens_count: number
      // exists
      subelemens_exists: boolean
    ...
    export interface Tapel {
      ...
      // counts
      kelas_count: number
      proyeks_count: number
      // exists
      kelas_exists: boolean
      proyeks_exists: boolean
    }
